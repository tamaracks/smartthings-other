 ...
 */
metadata {
	definition (name: "Wireless Tag PIR", namespace: "swanny", author: "swanny") {
	...
	tiles {
        ...
        /*standardTile("presence", "device.presence", canChangeBackground: true) {
			state "present", label:'motion', icon:"st.motion.motion.active", backgroundColor:"#53a7c0"
			state "not present", label:'no motion', icon:"st.motion.motion.inactive", backgroundColor:"#ffffff"
		}*/
       ...
       /* valueTile("doorClosed", "device.motionMode", inactiveLabel: false, decoration: "flat") {
		...
		details(["temperature", "humidity", "button", "beep", "refresh", "type", "rssi", "battery"])
	}
